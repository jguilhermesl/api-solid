...
// src/use-cases/validate-checkin.spec.ts
...
describe("Validate Checkin Use Case", () => {
  ...
  it("should be able to validate check in", async () => {
    ...
    globalExpect(validatedCheckin.validatedAt).toEqual(globalExpect.any(Date));
    globalExpect(checkInsRepository.items[0].validatedAt).toEqual(globalExpect.any(Date));
  });
  it("should not be able to validate check after 20 minutes of its creation", async () => {
    ...
    const TWENTY_ONE_MINUTES_IN_MS = 1e3 * 60 * 21;
